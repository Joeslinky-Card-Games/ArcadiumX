...
const GAMES = [
  ...
  { id: "yahtzee", name: "Yahtzee", description: "Roll five dice for 13 turns. Fill every box on the scorecard — highest total wins.", minPlayers: 1, maxPlayers: 6, status: "available" },
